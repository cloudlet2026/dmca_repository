...
module trapezd_alg #(
        ...
        input        signed  [  31: 0]      a_over_na_mul_a_minus_b    ,// a_over_na_mul_a_minus_b:a/(na*(a-b)的Q30定点数格式;
        input        signed  [  31: 0]      inv_na_mul_a_minus_b       ,// inv_na_mul_a_minus_b:1/(na*(a-b))的Q30定点数格式;
        input        signed  [  31: 0]      b                          ,// a=e^(-1/nf),nf为双指数下降沿衰减时间常数对应的采样周期数;
        // b=e^(-1/nr),nr为双指数上升沿衰减时间常数对应的采样周期数;
        //梯形输出
