...
################################################################
# This is a generated script based on design: bd_0696
#
...
proc create_root_design { parentCell } {
  ...
  set probe3 [ create_bd_port -dir I -from 17 -to 0 probe3 ]
  set probe4 [ create_bd_port -dir I -from 17 -to 0 probe4 ]
  ...
  set probe10 [ create_bd_port -dir I -from 11 -to 0 probe10 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_ILA_CLK_FREQ {66666672} \
